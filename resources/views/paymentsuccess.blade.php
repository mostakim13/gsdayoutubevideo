...
<br>
  ...
  <br>
    ...
    <form action="http://localhost:8000/user_profile">
      <button class="submit-btn" type="submit">
          Continue
      </button>
  </form>
    {{-- <button class="submit-btn" type="submit" onclick="window.location.href='http://localhost:8000/user_profile';">Continue</button> --}}
  </div>
<!-- partial -->
