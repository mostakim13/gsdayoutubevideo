                       ...
                       @if(count($section->lessons) > 0)
                           ...
                           @endif
                               <ul>
                                   ...
                                   <ul id="ulActive">
                                <a  data-autoplay="true" class="venobox" data-vbtype="video" class="venobox" data-autoplay="true" data-vbtype="video" href="{{ $lesson->youtube_url }}" data-gall="enrollGallery"  width="620" >

                                    {{-- <iframe style="position:absolute" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" frameborder="0" height="420" class="venobox" data-autoplay="true" data-vbtype="video" href="{{ $lesson->youtube_url }}" data-gall="enrollGallery"  width="620"><i class="fa fa-play"></i></iframe> --}}
              ...
              @foreach($course->sections as $section)
                  ...
                  <ul>
                      ...
                      <div style="position: absolute;">
                        <iframe allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" frameborder="0" height="420" data-autoplay="true" src="https://www.youtube.com/embed/c5cHjtspa7M?modestbranding=1&amp;rel=0&amp;disablekb=1&amp;showinfo=0"  width="620"><i class="fa fa-play"></i></iframe>
                      </div>
...
{{-- <!-- contact area END --><input src="" width="854" height="60" allowfullscreen> --}}
            ...
            <div style="position: relative;">
              <input type="text" style="width:620px; height: 60px; background-color: grey" name="" value="" disabled>
            </div>

              @endif
                     </div>
                            <div class="ttr-post-info" style="position: relative; margin-top: 420px;">
